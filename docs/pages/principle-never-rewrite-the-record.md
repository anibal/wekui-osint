title:: The record is never rewritten
type:: principle

- What happened, happened. We append; we never edit history to match new understanding.
- Where it already operates, verbatim:
  - [[post]] — "A Post is never edited and never deleted"; the Payload is kept whole because "we can never ask for it again."
