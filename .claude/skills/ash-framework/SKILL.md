---
name: ash-framework
description: "Use when creating or changing Ash resources, domains, actions, relationships, policies, calculations, or running codegen/migrations — any domain change under lib/wekui/."
metadata:
...
```sh
mix usage_rules.search_docs "search term" -p ash -p ash_sqlite -p ash_state_machine
```
